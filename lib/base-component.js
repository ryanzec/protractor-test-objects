...
var baseComponent = {
   ...
   * @method clickBrowser
   *
   * @param {number} vertical Where to click vertically (x)
   * @param {number horizontal Where to click horizontally (y)
   */
  clickBrowser: function(horizontal, vertical) {
    var x = horizontal || 0;
    var y = vertical || 0;
    browser.driver.actions().mouseMove({x: x, y: y}).click().perform();
  },
